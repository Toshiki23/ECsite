                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-footer">
                            ...
                            <form action="" method="post">
                                <input type="hidden" name="productId" value="<?php echo $good->getId() ?>">
                                <button class="btn btn-md btn-warning" type="submit" name="delete">Delete</button>
                            </form>
                        </div>
                    </div>
                </div>
  ...
  <!-- /.container -->
      <h2 class="font-bold text-center">合計金額：<?php echo $total ?>円</h2>
        <div class="text-center m-4">
            <button class="btn btn-lg btn-primary" style="margin: 0 auto;" onclick="location.href='order_confirm.php'">注文内容を確認する</button>
        </div>

  <!-- Footer -->
  <footer class="py-5 bg-dark">
      <p class="m-0 text-white">Copyright &copy; toshiblog 2019</p>
    <!-- /.container -->
  </footer>
